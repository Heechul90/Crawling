...
txt_id<-remDr$findElement(using="id",value="id") #id="~~~~"의 형식이 나타나는데, 차례대로 입력하면 된다.
...
df_mail <- date.frame(sender=sender, subject=subject, time=time)
df_mail
